...
public class edituser extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println(editar.getNombre());
		...
		webResource.request("application/json").accept("application/json").put(Entity.entity(editar,MediaType.APPLICATION_JSON),Usuario.class);
