                        ...
                        <div class="box">
                            ...
                            <form action="addevent" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input name="titulo" type="text" class="form-control" id="titulo-event" value="Titulo de Prueba">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="precio_entrada" type="text" class="form-control" id="precio_entrada" value=15>
                                </div>
                                <div class="form-group">
                                    <label for="fecha">Fecha del evento</label>
                                    <input name="fecha" type="datetime-local" class="form-control" id="fecha" value="2017-11-25T20:00">
                                </div>
                                <div class="form-group">
                                    <label for="lugar">Lugar</label>
                                    <input name="lugar" type="text" class="form-control" id="lugar" value="Lugar de Prueba">
                                </div>
                                <div class="form-group">
                                    <label for="descripcion">Descripción</label>
                                    <input name="descripcion" type="text" class="form-control" id="descripcion" value="Descripción de prueba">
                                </div>
                                <div class="form-group">
                                    <label for="numero_entradas">Número de entradas disponibles</label>
                                    <input name="numero_entradas" type="text" class="form-control" id="numero_entradas" value=550>
                                </div>
