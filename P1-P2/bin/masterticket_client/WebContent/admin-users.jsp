			 ...
			 _________________________________________________________ -->
                  ...
                  <% ArrayList<Usuario> usuarios = (ArrayList<Usuario>) request.getAttribute("usuarios"); %>
                    ...
                    <div class="col-md-9 clearfix" id="customer-order">
                    	...
                    	<% String eliminado = (String)request.getSession().getAttribute("eliminado"); %>
	                  	<% if(eliminado.compareTo("true") == 0) { %>
                          ...
                          <% } else { %>
                            <% for(Usuario viewuser : usuarios) { %>
                              <tr>
                                ...
                                <td style="width:30%;">
                                  <a href="edituser?id=<%= viewuser.getId() %>">
                                  ...
                                  <a href="deleteuser?id=<%= viewuser.getId() %>">
