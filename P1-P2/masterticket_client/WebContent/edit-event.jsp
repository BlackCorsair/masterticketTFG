                            ...
                            <form action="editevent" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="type" name="estado">
                                        <option value="disponible" <%if(modifiedEvent.getEstado() == "disponible"){ %>selected<%}%>>Disponible</option>
                                        <option value="completo" <%if(modifiedEvent.getEstado() == "completo"){ %>selected<%}%>>Completo</option>
                                        <option value="terminado" <%if(modifiedEvent.getEstado() == "terminado"){ %>selected<%}%>>Terminado</option>
                                        <option value="cancelado" <%if(modifiedEvent.getEstado() == "cancelado"){ %>selected<%}%>>Cancelado</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="precio_entrada" value="<%=modifiedEvent.getPrecioEntradas()%>" type="text" class="form-control" id="precio_entrada">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="lugar" value="<%=modifiedEvent.getPrecioEntradas()%>" type="text" class="form-control" id="lugar">
                                </div>
                                <div class="form-group">
